    ...
    def affichage(self):
        ...
        for x in range(5):
            for y in range(5):
                ...
                if val == 1:
                    self.canvas.create_oval(65 + x * 82, 65 + y * 82, 105 + x * 82, 105 + y * 82, fill='red')
                if val == 2:
                    self.canvas.create_oval(65 + x * 82, 65 + y * 82, 105 + x * 82, 105 + y * 82, fill='black')
                if val == 3:
                    self.canvas.create_oval(75 + x * 82, 75 + y * 82, 95 + x * 82, 95 + y * 82, fill='blue')
